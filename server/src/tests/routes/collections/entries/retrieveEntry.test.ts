...
describe('retrieveEntry', () => {
  // it('returns the public entry specified with the ID', async () => {
  ...
  // it('fails to returns the entry with an unauthenticated request', async () => {
  ...
  // it('fails to returns the entry to which the authenticated user has no permission', async () => {
